...
export default function AddNewModal () {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://127.0.0.1:8000/masters/', {
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-1 mt-2 mb-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
                    <li class="breadcrumb-item">
                            <a href="https://demolook.in/clarityboard/home/settings_super" class="text-muted">Settings</a>
                    </li>
                    <li class="breadcrumb-item">
                        <a href="https://demolook.in/clarityboard/home/sourcemaster_super" class="text-muted">{ name+" Master"}</a>
                    </li>
                    <li class="breadcrumb-item">
            ...
            <div class="card card-custom gutter-b">
                <div class="d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap p-5 border-bottom">
                    ...
                    <div class="d-flex align-items-center flex-wrap mr-2">
                        ...
                        <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{"Add "+name}</h5>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a href="https://demolook.in/clarityboard/home/clients" class="btn btn-default font-weight-bold"><i class="la la-arrow-left"></i> Back</a>
                       
                        <div class="btn-group ml-2">
                            <a>
                                <button onClick={handleSubmit} type="button" class="btn btn-primary font-weight-bold">Submit</button>
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="inner_down_forms">
                            <div class="ctm_repeater">
                                    ...
                                    <div data-repeater-item="" class="border-bottom form-group mb-3 row align-items-center parent">
                                        <div class="col-lg-4 col-md-4 col-12">
                                            ...
                                            <div key={index}class="form-group">
                                              <label class="lbl-heading">{name+" Title"} </label>
                                              <input
                                                type="text"
                                                name="title"
                                                class="form-control"
                                        ...
                                        <div class="col-lg-1 col-md-1 col-12">
                                               ...
                                               <a className='btn btn-light-danger btn-icon'> <FontAwesomeIcon icon={faTrash}/> </a>
                                ...
                                <div class="add-more-btn">
                                        ...
                                        <button onClick={handleAddMore}class="btn btn-success font-weight-bolder font-size-sm"><i class="la la-plus icon-md"></i> Add More</button>
