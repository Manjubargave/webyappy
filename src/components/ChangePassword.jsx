...
export default function ChangePassword() {
  ...
  function handlePasswordBlur() {
    if (!passwordRegex.test(password)) {
      setError(
        "Password must be alphanumeric and include at least one special character."
      );
    } else {
      setError("");
    }
  ...
  return (
    <>
      ...
      <div
        ...
        id="kt_content"
        style={{ left: "0", right: "0", position: "fixed", paddingTop: "80px" }}
      >
                      ...
                      <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group mb-3">
                          ...
                          <div className="input-container">
                            ...
                            <FontAwesomeIcon
                              icon={icon1}
                              className="icon-eye text-danger"
                              onClick={() => {
